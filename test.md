...
This is the **largest directory** and contains **read-only** user programs, libraries, and documentation.

Think of `/usr` as **“program files”** in Linux.

Inside `/usr` you will see:

### **/usr/bin**

Non-essential user binaries (but used daily).
...
Non-essential system admin binaries.

Example:
• `httpd`
• `cron`
• `sshd` (in many distros)
